...
namespace Descartes_Square
{
    public partial class MainWindow : Form
    {
        ...
        private void Strath_Click(object sender, EventArgs e)
        {
            ...
            if (a - b == 0)
            {
                label1.Text = "Мы не можем дать рекомендации в выбора за вами.";
            }
            else if (a - b >= 1)
            {
                label1.Text = "Мы советуем вам это сделать, но выбор остается за вами.";
            }
            else
            {
                label1.Text = "Мы не советуем вам это делается, но выбор остается за вами.";
            }
        }
